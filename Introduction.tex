...
This report describes an Linear Programming based method
...
Then, basic LPSBL, simplified LPSBL, incremental LPSBL and LPSBL with flip tolerance, are introduced in section \uppercase\expandafter{\romannumeral 3}, respectively.
